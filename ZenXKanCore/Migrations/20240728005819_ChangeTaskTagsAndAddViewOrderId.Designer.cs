...
namespace ZenXKanCore.Migrations
{
    ...
    [Migration("20240728005819_ChangeTaskTagsAndAddViewOrderId")]
    partial class ChangeTaskTagsAndAddViewOrderId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ZenXKanCore.Models.Task", b =>
                {
                    ...
                    b.Property<double>("ViewOrderId")
                        .HasColumnType("REAL")
                        .HasColumnName("view_order_id");
            ...
            modelBuilder.Entity("ZenXKanCore.Models.TaskTag", b =>
                {
                    ...
                    b.HasIndex("TaskId")
                        .HasDatabaseName("ix_task_tags_task_id");
